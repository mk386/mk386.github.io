...
preinfo() {
	...
	echo " 节点更新: 2022/09/21 | 脚本更新: 2021/12/23"
	echo " https://www.infski.com/speedtest"
	echo "——————————————————————————————————————————————————————————"
}

selecttest() {
	echo -e "  测速类型:    ${GREEN}0.${PLAIN} 取消测速    ${GREEN}1.${PLAIN} 三网测速    "
	echo -ne "               ${GREEN}2.${PLAIN} 电信节点    ${GREEN}3.${PLAIN} 联通节点    ${GREEN}4.${PLAIN} 移动节点"
	while :; do echo
...
runtest() {
	...
	if [[ ${selection} == 1 ]]; then
		...
		speed_test '26940' '宁夏银川５Ｇ' '移动'
		speed_test '53087' '广东深圳' '移动'
		#***
		speed_test '6715' '江苏昆山教育网' '教育'
		#***
		speed_test '35527' '四川成都广电网' '广电'
		speed_test '5530' '重庆广电网' '广电'
