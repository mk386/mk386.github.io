...
speed() {
    ...
    # Taiwan
    speed_test '29283' 'CNS        TW'  # CNS
    speed_test '36635' 'SEEDNET    TW'  # SEEDNET
    speed_test  '4505' 'Chief Tel. TW'  # Chief Telecom
    speed_test  '5334' 'TaiwanStar TW'  # Taiwan Star Telecom
    speed_test '18447' 'ChunghwaM. TW'  # Chunghwa Mobile
    speed_test '12583' 'TFN Media  TW'  # TFN Media
    speed_test '19211' 'FridayMediaTW'  # Friday Media
    speed_test '29106' 'AsiaPacificTW'  # Asia Pacific Telecom
    speed_test  '4938' 'Chief Tel. TW'  # Chief Telecom
    speed_test '11702' 'TaiwanMob. TW'  # Taiwan Mobile
}
